...
# Changes from generating 1 hour of wav files (default) to 3 hours
sed -i '' '22s/1/3.0/g' MS-SNSD/noisyspeech_synthesizer.cfg
...
# Ignores all types of background noise other than types of noise that are likely to contain human speech
sed -i '' '29s/None/AirportAnnouncements,Babble,CafeTeria,Cafe,Hallway,LivingRoom,Metro,Neighbor,NeighborSpeaking,Office,Restaurant,Square/g' MS-SNSD/noisyspeech_synthesizer.cfg
